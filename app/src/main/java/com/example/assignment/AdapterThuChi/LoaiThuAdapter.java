...
//    private String linkdatabase = "https://huyassignment-default-rtdb.firebaseio.com/";
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView imgSua, imgXoa, img_avataitemtc;
        RelativeLayout relativeLayouttc;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtTenKhoan = itemView.findViewById(R.id.textListtc);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.txtTenKhoan.setText(thuChi.getTenKhoan());
                    ...
                    public void onClick(View v) {
                        ...
                        them.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (themText.isEmpty()) {
                                    edtThemLoaiThu.setError("Không được để trống!");
                                    return;
                                }
