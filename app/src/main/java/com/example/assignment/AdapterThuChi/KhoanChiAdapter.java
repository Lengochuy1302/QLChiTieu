...
private String linkdatabase;
    ...
    public static List<GiaoDich> list;
            ...
            public void onClick(View view) {
                ...
                txtXemchiTiet.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        tien.setText("Giảm -"+ fm.format(giaoDich.getSoTien()) +" VND");
                        loai.setText("Loại chi: "+ giaoDich.getMaKhoan());
                        ...
                        reference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                for (DataSnapshot chilSnapshot:snapshot.getChildren()) {
                                    ...
                                    if ( maloai == 1) {
                                        listtv.add(namethuchi);
                                    }

                                }

                                final ArrayAdapter sp = new ArrayAdapter(context, R.layout.spiner_loaithuchi, listtv);
                                spLoaiGd.setAdapter(sp);
                                int vitri = -1;
                                for (int i = 0; i < listtv.size(); i++) {
                                    if (listtv.get(i).equalsIgnoreCase(giaoDich.getMaKhoan())) {
                                        vitri = i;
                                        break;
                                    }
                                }
